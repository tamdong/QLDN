 ...
 */
@ConvertAsProperties(dtd = "-//vn.com.hkt.tree.ui.department.thuchi//TreeDepartmentChiAll//EN",
autostore = false)
@TopComponent.Description(preferredID = "TreeDepartmentChiAllTopComponent",
//iconBase="SET/PATH/TO/ICON/HERE", 
persistenceType = TopComponent.PERSISTENCE_ALWAYS)
@TopComponent.Registration(mode = "editor", openAtStartup = false)
@ActionID(category = "Window", id = "vn.com.hkt.tree.ui.department.thuchi.TreeDepartmentChiAllTopComponent")
@ActionReference(path = "Menu/Window" /*, position = 333 */)
@TopComponent.OpenActionRegistration(displayName = "#CTL_TreeDepartmentChiAllAction",
preferredID = "TreeDepartmentChiAllTopComponent")
public final class TreeDepartmentChiAllTopComponent extends TopComponent {

    private PanelChi panelChi = new PanelChi();
    public TreeDepartmentChiAllTopComponent() {
        initComponents();
        setName(NbBundle.getMessage(TreeDepartmentChiAllTopComponent.class, "CTL_TreeDepartmentChiAllTopComponent"));
        setToolTipText(NbBundle.getMessage(TreeDepartmentChiAllTopComponent.class, "HINT_TreeDepartmentChiAllTopComponent"));
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(buttonTongQuan, org.openide.util.NbBundle.getMessage(TreeDepartmentChiAllTopComponent.class, "TreeDepartmentChiAllTopComponent.buttonTongQuan.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(buttonThu, org.openide.util.NbBundle.getMessage(TreeDepartmentChiAllTopComponent.class, "TreeDepartmentChiAllTopComponent.buttonThu.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(buttonChi, org.openide.util.NbBundle.getMessage(TreeDepartmentChiAllTopComponent.class, "TreeDepartmentChiAllTopComponent.buttonChi.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(buttonCanBang, org.openide.util.NbBundle.getMessage(TreeDepartmentChiAllTopComponent.class, "TreeDepartmentChiAllTopComponent.buttonCanBang.text")); // NOI18N
    ...
    public void componentOpened() {
        ...
        panelChart.add(new ChartMonthThuChiDepartment(panelChi.getEnterprise()));
