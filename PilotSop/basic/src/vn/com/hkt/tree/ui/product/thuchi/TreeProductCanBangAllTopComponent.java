 ...
 */
@ConvertAsProperties(dtd = "-//vn.com.hkt.tree.ui.product.thuchi//TreeProductCanBangAll//EN",
autostore = false)
@TopComponent.Description(preferredID = "TreeProductCanBangAllTopComponent",
//iconBase="SET/PATH/TO/ICON/HERE", 
persistenceType = TopComponent.PERSISTENCE_ALWAYS)
@TopComponent.Registration(mode = "editor", openAtStartup = false)
@ActionID(category = "Window", id = "vn.com.hkt.tree.ui.product.thuchi.TreeProductCanBangAllTopComponent")
@ActionReference(path = "Menu/Window" /*, position = 333 */)
@TopComponent.OpenActionRegistration(displayName = "#CTL_TreeProductCanBangAllAction",
preferredID = "TreeProductCanBangAllTopComponent")
public final class TreeProductCanBangAllTopComponent extends TopComponent {

    private PanelCanBang panelCanBang = new PanelCanBang();

    public TreeProductCanBangAllTopComponent() {
        initComponents();
        setName(NbBundle.getMessage(TreeProductCanBangAllTopComponent.class, "CTL_TreeProductCanBangAllTopComponent"));
        setToolTipText(NbBundle.getMessage(TreeProductCanBangAllTopComponent.class, "HINT_TreeProductCanBangAllTopComponent"));
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(buttonTongQuan, org.openide.util.NbBundle.getMessage(TreeProductCanBangAllTopComponent.class, "TreeProductCanBangAllTopComponent.buttonTongQuan.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(buttonThu, org.openide.util.NbBundle.getMessage(TreeProductCanBangAllTopComponent.class, "TreeProductCanBangAllTopComponent.buttonThu.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(buttonChi, org.openide.util.NbBundle.getMessage(TreeProductCanBangAllTopComponent.class, "TreeProductCanBangAllTopComponent.buttonChi.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(buttonCanBang, org.openide.util.NbBundle.getMessage(TreeProductCanBangAllTopComponent.class, "TreeProductCanBangAllTopComponent.buttonCanBang.text")); // NOI18N
    ...
    public void componentOpened() {
        ...
        panelChart.add(new ChartMonthThuChiProduct(panelCanBang.getEnterprise()));
