 ...
 */
@ConvertAsProperties(dtd = "-//vn.com.hkt.tree.ui.enterprise.thuchi.tongquan//TreeEnterpriseChiAll//EN",
autostore = false)
@TopComponent.Description(preferredID = "TreeEnterpriseChiAllTopComponent",
//iconBase="SET/PATH/TO/ICON/HERE", 
persistenceType = TopComponent.PERSISTENCE_ALWAYS)
@TopComponent.Registration(mode = "editor", openAtStartup = false)
@ActionID(category = "Window", id = "vn.com.hkt.tree.ui.enterprise.thuchi.tongquan.TreeEnterpriseChiAllTopComponent")
@ActionReference(path = "Menu/Window" /*, position = 333 */)
@TopComponent.OpenActionRegistration(displayName = "#CTL_TreeEnterpriseChiAllAction",
preferredID = "TreeEnterpriseChiAllTopComponent")
public final class TreeEnterpriseChiAllTopComponent extends TopComponent {

    private PanelChi panelChi = new PanelChi();
    public TreeEnterpriseChiAllTopComponent() {
        initComponents();
        setName(NbBundle.getMessage(TreeEnterpriseChiAllTopComponent.class, "CTL_TreeEnterpriseChiAllTopComponent"));
        setToolTipText(NbBundle.getMessage(TreeEnterpriseChiAllTopComponent.class, "HINT_TreeEnterpriseChiAllTopComponent"));
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(buttonTongQuan, org.openide.util.NbBundle.getMessage(TreeEnterpriseChiAllTopComponent.class, "TreeEnterpriseChiAllTopComponent.buttonTongQuan.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(buttonThu, org.openide.util.NbBundle.getMessage(TreeEnterpriseChiAllTopComponent.class, "TreeEnterpriseChiAllTopComponent.buttonThu.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(buttonChi, org.openide.util.NbBundle.getMessage(TreeEnterpriseChiAllTopComponent.class, "TreeEnterpriseChiAllTopComponent.buttonChi.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(buttonCanBang, org.openide.util.NbBundle.getMessage(TreeEnterpriseChiAllTopComponent.class, "TreeEnterpriseChiAllTopComponent.buttonCanBang.text")); // NOI18N
