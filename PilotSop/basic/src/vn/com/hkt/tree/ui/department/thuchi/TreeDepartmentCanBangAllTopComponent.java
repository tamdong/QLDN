 ...
 */
@ConvertAsProperties(dtd = "-//vn.com.hkt.tree.ui.department.thuchi//TreeDepartmentCanBangAll//EN",
autostore = false)
@TopComponent.Description(preferredID = "TreeDepartmentCanBangAllTopComponent",
//iconBase="SET/PATH/TO/ICON/HERE", 
persistenceType = TopComponent.PERSISTENCE_ALWAYS)
@TopComponent.Registration(mode = "editor", openAtStartup = false)
@ActionID(category = "Window", id = "vn.com.hkt.tree.ui.department.thuchi.TreeDepartmentCanBangAllTopComponent")
@ActionReference(path = "Menu/Window" /*, position = 333 */)
@TopComponent.OpenActionRegistration(displayName = "#CTL_TreeDepartmentCanBangAllAction",
preferredID = "TreeDepartmentCanBangAllTopComponent")
public final class TreeDepartmentCanBangAllTopComponent extends TopComponent {

    private PanelCanBang panelCanBang = new PanelCanBang();

    public TreeDepartmentCanBangAllTopComponent() {
        initComponents();
        setName(NbBundle.getMessage(TreeDepartmentCanBangAllTopComponent.class, "CTL_TreeDepartmentCanBangAllTopComponent"));
        setToolTipText(NbBundle.getMessage(TreeDepartmentCanBangAllTopComponent.class, "HINT_TreeDepartmentCanBangAllTopComponent"));
        ...
        associateLookup(ExplorerUtils.createLookup(panelCanBang.getExplorerManager(), getActionMap()));
    }
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(buttonTongQuan, org.openide.util.NbBundle.getMessage(TreeDepartmentCanBangAllTopComponent.class, "TreeDepartmentCanBangAllTopComponent.buttonTongQuan.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(buttonThu, org.openide.util.NbBundle.getMessage(TreeDepartmentCanBangAllTopComponent.class, "TreeDepartmentCanBangAllTopComponent.buttonThu.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(buttonChi, org.openide.util.NbBundle.getMessage(TreeDepartmentCanBangAllTopComponent.class, "TreeDepartmentCanBangAllTopComponent.buttonChi.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(buttonCanBang, org.openide.util.NbBundle.getMessage(TreeDepartmentCanBangAllTopComponent.class, "TreeDepartmentCanBangAllTopComponent.buttonCanBang.text")); // NOI18N
    ...
    public void componentOpened() {
        ...
        panelChart.add(new ChartMonthThuChiDepartment(panelCanBang.getEnterprise()));
        panelTree.add(panelCanBang);
        buttonCanBang.setEnabled(false);
    }
