 ...
 * @author longnt
 */
public class EnterpriseParentTongQuan extends Children.Keys {
   ...
   public static String ThuMonth1_PROPERTY = "ThuM1";
    ...
    public EnterpriseParentTongQuan(boolean lazy) {
        super(lazy);
    }

    public EnterpriseParentTongQuan(Enterprise enterprise) {
    ...
    protected Node[] createNodes(Object key) {
        ...
        Node result = new AbstractNode(new EnterpriseChildrenTongQuan(enterprise1), Lookups.singleton(enterprise1)) {
