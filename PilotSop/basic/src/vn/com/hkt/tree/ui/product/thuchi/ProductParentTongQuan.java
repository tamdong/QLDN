 ...
 * @author longnt
 */
public class ProductParentTongQuan extends Children.Keys {
    ...
    public ProductParentTongQuan(boolean lazy) {
        super(lazy);
    }

    public ProductParentTongQuan(Product product, Enterprise enterprise) {
    ...
    protected Node[] createNodes(Object key) {
        ...
        Node result = new AbstractNode(new ProductChildrenTongQuan(product1, enterprise), Lookups.singleton(product1)) {
