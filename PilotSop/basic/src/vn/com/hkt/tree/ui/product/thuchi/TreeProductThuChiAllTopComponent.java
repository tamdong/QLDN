 ...
 */
@ConvertAsProperties(dtd = "-//vn.com.hkt.tree.ui.product.thuchi//TreeProductThuChiAll//EN",
autostore = false)
@TopComponent.Description(preferredID = "TreeProductThuChiAllTopComponent",
//iconBase="SET/PATH/TO/ICON/HERE", 
persistenceType = TopComponent.PERSISTENCE_ALWAYS)
@TopComponent.Registration(mode = "editor", openAtStartup = false)
@ActionID(category = "Window", id = "vn.com.hkt.tree.ui.product.thuchi.TreeProductThuChiAllTopComponent")
@ActionReference(path = "Menu/Kinh Doanh" /*, position = 333 */)
@TopComponent.OpenActionRegistration(displayName = "#CTL_TreeProductThuChiAllAction",
preferredID = "TreeProductThuChiAllTopComponent")
public final class TreeProductThuChiAllTopComponent extends TopComponent {

    private PanelTongQuan panelTongQuan = new PanelTongQuan();

    public TreeProductThuChiAllTopComponent() {
        initComponents();
        setName(NbBundle.getMessage(TreeProductThuChiAllTopComponent.class, "CTL_TreeProductThuChiAllTopComponent"));
        setToolTipText(NbBundle.getMessage(TreeProductThuChiAllTopComponent.class, "HINT_TreeProductThuChiAllTopComponent"));
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(buttonTongQuan, org.openide.util.NbBundle.getMessage(TreeProductThuChiAllTopComponent.class, "TreeProductThuChiAllTopComponent.buttonTongQuan.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(buttonThu, org.openide.util.NbBundle.getMessage(TreeProductThuChiAllTopComponent.class, "TreeProductThuChiAllTopComponent.buttonThu.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(buttonChi, org.openide.util.NbBundle.getMessage(TreeProductThuChiAllTopComponent.class, "TreeProductThuChiAllTopComponent.buttonChi.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(buttonCanBang, org.openide.util.NbBundle.getMessage(TreeProductThuChiAllTopComponent.class, "TreeProductThuChiAllTopComponent.buttonCanBang.text")); // NOI18N
    ...
    public void componentOpened() {
        ...
        panelChart.add(new ChartMonthThuChiProduct(panelTongQuan.getEnterprise()));
