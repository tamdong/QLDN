 ...
 */
@ConvertAsProperties(dtd = "-//vn.com.hkt.tree.ui.enterprise.thuchi.tongquan//TreeEnterpriseCanBangAll//EN",
autostore = false)
@TopComponent.Description(preferredID = "TreeEnterpriseCanBangAllTopComponent",
//iconBase="SET/PATH/TO/ICON/HERE", 
persistenceType = TopComponent.PERSISTENCE_ALWAYS)
@TopComponent.Registration(mode = "editor", openAtStartup = false)
@ActionID(category = "Window", id = "vn.com.hkt.tree.ui.enterprise.thuchi.tongquan.TreeEnterpriseCanBangAllTopComponent")
@ActionReference(path = "Menu/Window" /*, position = 333 */)
@TopComponent.OpenActionRegistration(displayName = "#CTL_TreeEnterpriseCanBangAllAction",
preferredID = "TreeEnterpriseCanBangAllTopComponent")
public final class TreeEnterpriseCanBangAllTopComponent extends TopComponent {

    private PanelCanBang panelCanBang = new PanelCanBang();

    public TreeEnterpriseCanBangAllTopComponent() {
        initComponents();
        setName(NbBundle.getMessage(TreeEnterpriseCanBangAllTopComponent.class, "CTL_TreeEnterpriseCanBangAllTopComponent"));
        setToolTipText(NbBundle.getMessage(TreeEnterpriseCanBangAllTopComponent.class, "HINT_TreeEnterpriseCanBangAllTopComponent"));
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(buttonTongQuan, org.openide.util.NbBundle.getMessage(TreeEnterpriseCanBangAllTopComponent.class, "TreeEnterpriseCanBangAllTopComponent.buttonTongQuan.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(buttonThu, org.openide.util.NbBundle.getMessage(TreeEnterpriseCanBangAllTopComponent.class, "TreeEnterpriseCanBangAllTopComponent.buttonThu.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(buttonChi, org.openide.util.NbBundle.getMessage(TreeEnterpriseCanBangAllTopComponent.class, "TreeEnterpriseCanBangAllTopComponent.buttonChi.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(buttonCanBang, org.openide.util.NbBundle.getMessage(TreeEnterpriseCanBangAllTopComponent.class, "TreeEnterpriseCanBangAllTopComponent.buttonCanBang.text")); // NOI18N
