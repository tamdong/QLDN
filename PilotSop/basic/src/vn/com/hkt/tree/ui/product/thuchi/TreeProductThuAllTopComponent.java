 ...
 */
@ConvertAsProperties(dtd = "-//vn.com.hkt.tree.ui.product.thuchi//TreeProductThuAll//EN",
autostore = false)
@TopComponent.Description(preferredID = "TreeProductThuAllTopComponent",
//iconBase="SET/PATH/TO/ICON/HERE", 
persistenceType = TopComponent.PERSISTENCE_ALWAYS)
@TopComponent.Registration(mode = "editor", openAtStartup = false)
@ActionID(category = "Window", id = "vn.com.hkt.tree.ui.product.thuchi.TreeProductThuAllTopComponent")
@ActionReference(path = "Menu/Window" /*, position = 333 */)
@TopComponent.OpenActionRegistration(displayName = "#CTL_TreeProductThuAllAction",
preferredID = "TreeProductThuAllTopComponent")
public final class TreeProductThuAllTopComponent extends TopComponent {

    private PanelThu panelThu = new PanelThu();

    public TreeProductThuAllTopComponent() {
        initComponents();
        setName(NbBundle.getMessage(TreeProductThuAllTopComponent.class, "CTL_TreeProductThuAllTopComponent"));
        setToolTipText(NbBundle.getMessage(TreeProductThuAllTopComponent.class, "HINT_TreeProductThuAllTopComponent"));
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(buttonTongQuan, org.openide.util.NbBundle.getMessage(TreeProductThuAllTopComponent.class, "TreeProductThuAllTopComponent.buttonTongQuan.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(buttonThu, org.openide.util.NbBundle.getMessage(TreeProductThuAllTopComponent.class, "TreeProductThuAllTopComponent.buttonThu.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(buttonChi, org.openide.util.NbBundle.getMessage(TreeProductThuAllTopComponent.class, "TreeProductThuAllTopComponent.buttonChi.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(buttonCanBang, org.openide.util.NbBundle.getMessage(TreeProductThuAllTopComponent.class, "TreeProductThuAllTopComponent.buttonCanBang.text")); // NOI18N
    ...
    public void componentOpened() {
        ...
        panelChart.add(new ChartMonthThuChiProduct(panelThu.getEnterprise()));
        panelTree.removeAll();
