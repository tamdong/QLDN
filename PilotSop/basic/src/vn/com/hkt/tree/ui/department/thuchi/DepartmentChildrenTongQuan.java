 ...
 * @author longnt
 */
public class DepartmentChildrenTongQuan extends Children.Keys {
    ...
    public DepartmentChildrenTongQuan(boolean lazy) {
        super(lazy);
    }

    public DepartmentChildrenTongQuan(Department department, Enterprise enterprise) {
    ...
    protected Node[] createNodes(Object key) {
        ...
        Node result;
        result = new AbstractNode(new DepartmentChildrenTongQuan(department1, enterprise), Lookups.singleton(department1)) {
    ...
    protected void addNotify() {
        ...
        for (int i = 0; i < list.size(); i++) {
            if (list.get(i).getDepartmentParent().equals(department.getDepartmentName())) {
                ...
                //department1.setDirector(list.get(i).getDirector());
