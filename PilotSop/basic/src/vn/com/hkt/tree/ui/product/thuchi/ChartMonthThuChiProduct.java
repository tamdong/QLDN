 ...
 * @author longnt
 */
public final class ChartMonthThuChiProduct extends javax.swing.JPanel implements ActionListener, ChangeListener, LookupListener {
    ...
    public ChartMonthThuChiProduct(Enterprise enterprise) {
        ...
        TreeProductThuChiAllTopComponent tc1 = (TreeProductThuChiAllTopComponent) WindowManager.getDefault().findTopComponent("TreeProductThuChiAllTopComponent");
         TreeProductChiAllTopComponent tc2 = (TreeProductChiAllTopComponent) WindowManager.getDefault().findTopComponent("TreeProductChiAllTopComponent");
        TreeProductCanBangAllTopComponent tc3 = (TreeProductCanBangAllTopComponent) WindowManager.getDefault().findTopComponent("TreeProductCanBangAllTopComponent");
        if(tc.isOpened()){
            result = tc.getLookup().lookupResult(Product.class);
        }
        if(tc1.isOpened()){
            result = tc1.getLookup().lookupResult(Product.class);
        }
         if(tc2.isOpened()){
            result = tc2.getLookup().lookupResult(Product.class);
        }
          if(tc3.isOpened()){
            result = tc3.getLookup().lookupResult(Product.class);
        }
    ...
    public XYDataset createDataset(int m1, int y1, int m2, int y2) {
        ...
        //Product Product = ProductBN.
        if (y1 == y2) {
            for (int i = m1; i <= m2; i++) {
                String str = String.valueOf(i) + "/" + String.valueOf(y1);
                series1.add(new Month(i, y1), calculate.calculateImportByMonthOfProduct(enterprise, product, str));
                series2.add(new Month(i, y1), calculate.calculateExportByMonthOfProduct(enterprise, product, str));
            }
        }
    ...
    private void initComponents() {
        ...
        jLabel2.setText(org.openide.util.NbBundle.getMessage(ChartMonthThuChiProduct.class, "ChartMonthThuChiProduct.jLabel2.text")); // NOI18N

        jLabel5.setText(org.openide.util.NbBundle.getMessage(ChartMonthThuChiProduct.class, "ChartMonthThuChiProduct.jLabel5.text")); // NOI18N

        buttonXem.setText(org.openide.util.NbBundle.getMessage(ChartMonthThuChiProduct.class, "ChartMonthThuChiProduct.buttonXem.text")); // NOI18N
    ...
    public void resultChanged(LookupEvent le) {
        ...
        Collection<Product> c1 = r.allInstances();
        if (!c1.isEmpty()) {
            for (Product e : c1) {
                product = e;
