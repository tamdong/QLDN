    ...
    private void txtTimKiemCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_txtTimKiemCaretUpdate
        ...
        if (cboTimkiem.getSelectedIndex() == 0) {
            ...
            for (Department bean : list) {
                String[] rows = {bean.getDepartmentName(), bean.getDepartmentID(), bean.getEnterpriseID(), bean.getPersonID(), bean.getDecentralization(), bean.getDepartmentParent(), bean.getProductID()};
                model.addRow(rows);
            }
                    ...
                    if (buttonEdit.isEnabled() == false) {
                        ...
                        departmentTopComponent.getDepartmentPanel().getTableD().setModel(new javax.swing.table.DefaultTableModel(
                                new Object[][]{
                                    ...
                                    {"Phân cấp", department.getDecentralization()},
                        ...
                        departmentCell.getTxtPhancap().setText(department.getDecentralization());
