 ...
 * ChartOperation.java
 *
 * Created on Nov 30, 2011, 10:34:28 AM
 */
 ...
 * @author longnt
 */
public class ChartOperation extends javax.swing.JPanel implements ActionListener, ItemListener {
    ...
    private int year1=2007;
    private int year2=2007;
    ...
    /** Creates new form ChartOperation */
    public ChartOperation() {
        initComponents();
        this.iCount = Lookup.getDefault().lookup(ICount.class);
    ...
    public XYDataset createDataset(int m1, int y1, int m2, int y2) {
        ...
        // Create dataset Thu
        TimeSeries series1 = new TimeSeries("Bán", Month.class);
        TimeSeries series2 = new TimeSeries("Mua", Month.class);

        if (y1 == y2) {
            for (int i = m1; i <= m2; i++) {         
                String day = modelThang1.getElementAt(i - 1).toString()+"/"+String.valueOf(y1);
                series1.add(new Month(Integer.parseInt(modelThang1.getElementAt(i - 1).toString()), y1), iCount.countOperation(enterprise,"Thu", day));
                series2.add(new Month(Integer.parseInt(modelThang1.getElementAt(i - 1).toString()), y1), iCount.countOperation(enterprise,"Chi", day));
            }
        }
    ...
    public JFreeChart createChart(int m1, int y1, int m2, int y2) {
        ...
        JFreeChart chart = ChartFactory.createTimeSeriesChart(" ", "Tháng", "Số lượng", data, true, true, false);
    ...
    private void initComponents() {
        ...
        jLabel1.setText(org.openide.util.NbBundle.getMessage(ChartOperation.class, "ChartOperation.jLabel1.text")); // NOI18N

        jLabel2.setText(org.openide.util.NbBundle.getMessage(ChartOperation.class, "ChartOperation.jLabel2.text")); // NOI18N
        ...
        jLabel4.setText(org.openide.util.NbBundle.getMessage(ChartOperation.class, "ChartOperation.jLabel4.text")); // NOI18N

        cboNam1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { " " }));
        cboNam1.setPreferredSize(new java.awt.Dimension(56, 20));

        jLabel5.setText(org.openide.util.NbBundle.getMessage(ChartOperation.class, "ChartOperation.jLabel5.text")); // NOI18N
        ...
        jLabel7.setText(org.openide.util.NbBundle.getMessage(ChartOperation.class, "ChartOperation.jLabel7.text")); // NOI18N

        cboNam2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { " " }));
        cboNam2.setPreferredSize(new java.awt.Dimension(56, 20));

        buttonXem.setText(org.openide.util.NbBundle.getMessage(ChartOperation.class, "ChartOperation.buttonXem.text")); // NOI18N

        jLabel3.setText(org.openide.util.NbBundle.getMessage(ChartOperation.class, "ChartOperation.jLabel3.text")); // NOI18N
    ...
    protected void getModelEnterprise() {
